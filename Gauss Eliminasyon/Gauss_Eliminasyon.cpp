...
int main()
{
	...
	// Matris = Artýrýlmýþ Matris [N]
	float temp,s;
	//döngüler için deðiþkenler
	int i,j,k;

	//Matrix'in deðerlerini tarayýn.
	...
	for(i=0; i<N; i++)
	{
	 ...
	 //Yukarýdaki matrisi üst üçgen Matrix yapma
	for(j=0; j<N-1; j++)
	{
		for(i=j+1; i<N; i++)
		{
